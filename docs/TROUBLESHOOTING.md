...
1. Keep `cloudflared tunnel run odyssey-bot` running.
...
1. Put the Odyssey Bot role above roles it needs to assign or moderate.
...
1. Move the Odyssey Bot role above staff, verified, muted, ticket, and self-service roles it must manage.
...
- Choose a verified/community role and move the Odyssey Bot role above it.
...
- Move the Odyssey Bot role above the verified role.
- Grant Manage Roles.
