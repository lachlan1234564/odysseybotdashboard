export const dashboardSearchItems = [
  ...
  { category: "Page", label: "Moderation", description: "Warnings and moderation records", page: "moderation", aliases: ["mod logs", "warnings", "ban", "kick", "timeout"] },
  ...
  { category: "Page", label: "Verification", description: "Discord OAuth member verification", page: "security", securityView: "verification", aliases: ["verify", "oauth", "vpn check"] },
  ...
  { category: "Page", label: "Role Panels", description: "Self-service reaction role buttons", page: "automation", automationView: "role-panels", aliases: ["reaction roles", "button roles", "self roles", "role panel"] },
  { category: "Action", label: "Create a role panel", description: "Build a self-service role button panel", page: "automation", automationView: "role-panels", targetId: "role-panel-form", aliases: ["new reaction roles", "add role buttons"] },
  ...
  { category: "Guide", label: "Quick Start guide", description: "Install dependencies and launch Odyssey Bot", page: "docs", docTopic: "quick-start", aliases: ["install bot", "run bot", "download github"] },
